...
export default function AboutPage() {
 ...
 aged 10 to 15 years from peri-urban communities in Ghana.
 </p>
 <div
 style={{
 display: "grid",
 ...
 <div style={{ fontSize: "0.85rem", opacity: 0.95 }}>SDGs 1-6 for ages 10 to 12</div>
 </div>
 ...
 <div style={{ fontSize: "0.85rem", opacity: 0.95 }}>SDGs 7-12 for ages 13 to 15</div>
 </div>
 </div>
