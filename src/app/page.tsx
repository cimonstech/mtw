...
import { ArrowRight, BookOpen, CheckCircle2, Globe2, Handshake, Newspaper, PlayCircle, Quote, Sparkles } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <>
        ...
        >
          <div>
            ...
            <p style={{ fontSize: "1rem", color: "rgba(255,255,255,0.7)", lineHeight: 1.8, maxWidth: "440px", margin: "0 0 2.5rem" }}>
              Enabling a confident and skilful next generation of change makers. We use the SDGs as learning themes to engage students aged 10–15 from peri-urban communities in Ghana.
            </p>
      ...
      {/* 4. PROGRAMMES INTRO */}
      <section id="programmes" style={{ background: "#F8FFFE", padding: "6rem 1.5rem" }}>
        <div style={wrap}>
          <div style={twoCol}>
            <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            ...
            <div style={{ position: "relative", overflow: "visible" }}>
              ...
              >
                <p style={{ margin: 0, fontSize: "0.68rem", fontWeight: 700, color: "rgba(255,255,255,0.6)", textTransform: "uppercase" }}>SDG Coverage</p>
      ...
      {/* 8. PARTNERS */}
      <section style={{ background: "#F0FAFA", padding: "4rem 1.5rem", borderBottom: "1px solid #E5E7EB" }}>
        <div style={wrap}>
        ...
        <div style={wrap}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 380px), 1fr))", gap: "1.5rem" }}>
            {[
              ...
              <div key={t.name} style={{ ...cardStyle, padding: "2rem", display: "flex", flexDirection: "column", gap: "1.25rem", borderTop: "3px solid #2BBFB3" }}>
