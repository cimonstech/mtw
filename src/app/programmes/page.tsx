...
export default function ProgrammesPage() {
 ...
 <p style={{ margin: 0, fontSize: "0.68rem", fontWeight: 700, color: "#2BBFB3", textTransform: "uppercase", letterSpacing: "0.06em" }}>SDGs Coverage</p>
 ...
 <SdgIconSlider from={1} to={12} size={18} gap="0.3rem" theme="light" />
 </div>
 </div>
 </div>
 </section>
 ...
 Building global citizens aged 10 to 12
 </h2>
 <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem", marginBottom: "1rem" }}>
 <span style={pill}>Ages 10 to 12</span>
 <span style={pill}>SDGs 1-6</span>
 </div>
 <div style={{ marginBottom: "1rem" }}>
 <SdgIconRange from={1} to={6} size={32} gap="0.4rem" />
 </div>
 <p style={{ color: muted, lineHeight: 1.75, margin: "0 0 1.5rem" }}>
 Our very first programme, for students aged 10 to 12, is centered on SDGs 1-6. Each session focuses on an SDG with interactive activities to support engagement and learning of the SDG.
 </p>
 ...
 <h2 style={{ fontSize: "clamp(1.5rem, 3vw, 2rem)", fontWeight: 800, color: dark, margin: "0 0 1rem" }}>
 Community action for ages 13 to 15
 </h2>
 <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem", marginBottom: "1rem" }}>
 <span style={pill}>Ages 13 to 15</span>
 <span style={pill}>SDGs 7-12</span>
 </div>
 <div style={{ marginBottom: "1rem" }}>
 <SdgIconRange from={7} to={12} size={32} gap="0.4rem" />
 </div>
 <p style={{ color: muted, lineHeight: 1.75, margin: "0 0 1.5rem" }}>
